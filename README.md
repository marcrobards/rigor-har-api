...
A REST API for storing and analyzing HAR files implemented in .NET Core 2.2. It uses the built-in dependency injection framework, Entity Framework Core for data storage, and Moq and xUnit for testing.
